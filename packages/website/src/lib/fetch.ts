...
type ISRawFetch<T extends ExtendFetchOptions> = T extends ExtendFetchOptions ? T['native'] extends boolean ? T['native'] : false : never
...
export class Fetch {
  ...
  get<T extends any = unknown, F extends ExtendFetchOptions = ExtendFetchOptions>(request: string, options?: F):Promise<FetchReturnType<T,F>> {
    return this.fetch(request, { ...options, method: 'GET' })
  }
  post<T extends any = unknown, F extends ExtendFetchOptions = ExtendFetchOptions>(request: string, options?: ExtendFetchOptions):Promise<FetchReturnType<T,F>> {
    return this.fetch(request, { ...options, method: 'POST' })
  }
  put<T extends any = unknown, F extends ExtendFetchOptions = ExtendFetchOptions>(request: string, options?: ExtendFetchOptions):Promise<FetchReturnType<T,F>> {
    return this.fetch(request, { ...options, method: 'PUT' })
  }
  patch<T extends any = unknown, F extends ExtendFetchOptions = ExtendFetchOptions>(request: string, options?: ExtendFetchOptions):Promise<FetchReturnType<T,F>> {
    return this.fetch(request, { ...options, method: 'PATCH' })
  }
  delete<T extends any = unknown, F extends ExtendFetchOptions = ExtendFetchOptions>(request: string, options?: ExtendFetchOptions):Promise<FetchReturnType<T,F>> {
    return this.fetch(request, { ...options, method: 'DELETE' })
  }
  head<F extends ExtendFetchOptions = ExtendFetchOptions>(request: string, options?: ExtendFetchOptions):Promise<FetchReturnType<unknown,F>> {
