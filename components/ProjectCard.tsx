...
export default defineComponent({
    ...
    setup({ title, description, preview, github, link }) {
      return()=> (
        <>
            <div class="max-w-sm mx-auto bg-white-100 dark:bg-gray-700 md:w-68 lg:w-72 xl:w-80  rounded-xl shadow-md overflow-hidden">
            
            <img class="w-full object-contain max-h-40" src={preview} alt={title}/>
