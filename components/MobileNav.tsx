    ...
    setup() {
        ...
        return () => (
            <div class="sm:hidden ">
              ...
              <div
                class={`fixed top-0 left-0 h-full w-full transform bg-gray-200 opacity-95 duration-300 ease-in-out dark:bg-gray-800 ${navShow.value?'translate-x-0':'translate-x-full'}`}
              >
